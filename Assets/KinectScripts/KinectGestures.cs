                ...
                switch (gestureData.state)
                {
                    case 0:   // gesture phase 1 = Detect
                        if (jointsTracked[rightHandIndex] && 
                            ...
                            jointsPos[rightHandIndex].y >= gestureBottom && 
            ...
            case Gestures.Left:
                switch (gestureData.state)
                {
                    ...
                    case 1:  // gesture phase 2 = complete
                        ...
                        {
                            bool isInPose = jointsTracked[rightHandIndex] && jointsTracked[rightElbowIndex] && jointsTracked[rightShoulderIndex] &&
                                Mathf.Abs(jointsPos[rightElbowIndex].y - jointsPos[rightShoulderIndex].y) < 0.1f &&
                ...
                switch (gestureData.state)
                {
                    case 0:  // gesture phase 1 = Detect
                        if (jointsTracked[leftHandIndex] && 
                            ...
                            jointsTracked[leftHipIndex] && 
                            jointsTracked[rightHipIndex] &&
                            jointsPos[leftHandIndex].y >= gestureBottom && 
                            jointsPos[leftHandIndex].y <= gestureTop &&
                    ...
                    case 1:  // gesture phase 2 = complete
                        if ((timestamp - gestureData.timestamp) < 1.5f)
                        {
                            bool isInPose = jointsTracked[leftHandIndex] && 
                                jointsTracked[hipCenterIndex] && 
                                jointsTracked[shoulderCenterIndex] && 
                                jointsTracked[leftHipIndex] && 
                                jointsTracked[rightHipIndex] &&
